...
const AddSerum: React.FC<AddFeaturedProps> = ({
  openModal,
  onCloseModal,
  onProductAdded,
}) => {
  ...
  const handleAddProduct = async () => {
    ...
    try {
      await axios.post("http://localhost:5000/api/products/serums", formData, {
        headers: {
  ...
  return (
    <Modal show={openModal} onClose={onCloseModal}>
      <Modal.Header>Add Serum</Modal.Header>
      <Modal.Body>
